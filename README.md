...
`⟨FILL FROM NOTEBOOK: sebutkan fitur turunan yang Anda buat, mis. interaksi suhu×angin, indeks dryness, rasio vegetasi, binning musiman/diurnal, dsb. Sebutkan dari berapa fitur menjadi berapa fitur.⟩`
...
3. **Jalankan semua cell** — `Runtime → Run all`. Semua dependency (pandas, numpy, scikit-learn, dll.) sudah tersedia secara default di Colab.
...
- **XGBoost** — Modeling
- **IMB-learn** — Pipeline & Oversampling
- **Scipy**,**datetime**,**math** — Feature engineering
